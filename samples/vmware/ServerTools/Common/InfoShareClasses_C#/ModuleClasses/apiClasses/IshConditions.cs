...
namespace ISHModulesNS
{
	...
	public class IshConditions : mainAPIclass
	{
		#region "Private Members"
			#endregion
		private readonly string strModuleName = "ISHConditions";
		#region "Constructors"
		public IshConditions(string Username, string Password, string ServerURL)
		{
