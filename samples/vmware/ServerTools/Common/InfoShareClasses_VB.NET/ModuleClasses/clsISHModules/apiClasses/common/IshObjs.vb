...
Public Class ISHObjs
    ...
    Public ISHAppObj As Application25ServiceReference.ApplicationClient
    Public ISHDocObj As DocumentObj20ServiceReference.DocumentObjClient
    Public ISHDocObj25 As DocumentObj25ServiceReference.DocumentObjClient
    Public ISHBaselineObj As Baseline25ServiceReference.BaselineClient
    Public ISHCondObj As ConditionManagement10ServiceReference.ConditionManagementClient
    Public ISHListOfValuesObj As ListOfValues25ServiceReference.ListOfValuesClient
    Public ISHMetaObj As MetaDataAssist20ServiceReference.MetaDataAssistClient
    Public ISHOutputObj As OutputFormat20ServiceReference.OutputFormatClient
    Public ISHPubObj As Publication20ServiceReference.PublicationClient
    Public ISHPubOutObj20 As PublicationOutput20ServiceReference.PublicationOutputClient
    Public ISHPubOutObj25 As PublicationOutput25ServiceReference.PublicationOutputClient
    Public ISHFolderObj As Folder20ServiceReference.FolderClient
    Public ISHReportsObj As Reports20ServiceReference.ReportsClient
    Public ISHSearchObj As Search20ServiceReference.SearchClient
    Public ISHWorkflowObj As Workflow20ServiceReference.WorkflowClient
    Public ISHUserObj As User25ServiceReference.UserClient
