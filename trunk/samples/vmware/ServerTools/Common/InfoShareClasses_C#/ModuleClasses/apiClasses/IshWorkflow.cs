...
namespace ISHModulesNS
{
	...
	public class IshWorkflow : mainAPIclass
	{
		#region "Private Members"
			#endregion
		private readonly string strModuleName = "IshWorkFlow";
		#region "Constructors"
		public IshWorkflow(string Username, string Password, string ServerURL)
		{
