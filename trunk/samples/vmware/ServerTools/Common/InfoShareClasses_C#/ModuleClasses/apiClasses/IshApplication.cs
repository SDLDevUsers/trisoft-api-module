...
namespace ISHModulesNS
{
	...
	public class IshApplication : mainAPIclass
	{
		#region "Private Members"
			#endregion
		private readonly string strModuleName = "ISHApplication";
		#region "Constructors"
		public IshApplication(string Username, string Password, string ServerURL)
		{
