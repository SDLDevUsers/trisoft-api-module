...
{
	public class IshReports : mainAPIclass
	{
		#region "Private Members"

		#endregion
		#region "Constructors"
		public IshReports(string Username, string Password, string ServerURL)
		{
		...
		#region "Properties"
			#endregion
		private readonly string strModuleName = "IshReports";
		#region "Methods"
